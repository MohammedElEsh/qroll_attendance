...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 100,
        centerTitle: true, // Ensures the title (image) is centered on both Android and iOS
          title: Image.asset(
                      ...
                      child: GridView.count(
                        ...
                        children: [
                          _buildFeatureCard(
                            ...
                            color: Colors.blue,
                            onTap: () => _navigateToScreen(const QRScannerScreen()),
                          ),
                          _buildFeatureCard(
                            ...
                            color: Colors.green,
                            onTap: () => _navigateToScreen(const AttendanceReportScreen()),
                          ),
                          _buildFeatureCard(
                            icon: Icons.person,
                            title: 'Profile',
